...
// 用法：node check_coverage.mjs ../no1_test_plan/no1_rules.md ../no1_test_plan/no2_scenarios.md
import fs from 'fs'
import { fileURLToPath } from 'url'

const rulesFile = process.argv[2] ?? fileURLToPath(new URL('../no1_test_plan/no1_rules.md', import.meta.url))
const scenFile = process.argv[3] ?? fileURLToPath(new URL('../no1_test_plan/no2_scenarios.md', import.meta.url))
