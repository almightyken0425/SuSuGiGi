...
//
// 前置：把 Firebase console 產的私鑰存為 no2_qa_tools/serviceAccountKey.json，不進 git。
// 專案：susugigi-c4fb1。
//
// 用法：
//   node no2_qa_tools/fs_admin.mjs get users/<uid>
//   node no2_qa_tools/fs_admin.mjs get entitlements/<uid>
//   node no2_qa_tools/fs_admin.mjs count users/<uid>/transactions
//   node no2_qa_tools/fs_admin.mjs query users/<uid>/transactions 5      前 5 筆
//   node no2_qa_tools/fs_admin.mjs set entitlements/<uid> '{"tier":1,"status":"active"}'
//   node no2_qa_tools/fs_admin.mjs set users/<uid> '{"preferences":{"launchMode":"expense"}}'
//
