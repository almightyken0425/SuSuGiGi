...
| Glyph / DynamicIconById / IconOutline / PhosphorIcon | DynamicIcon / phosphorIconMap | design 收斂 4→2（**B5**）|
...
- ⏳ Icon 系統 design 收斂 4→2（**B5 後續**，影響 25 screens 改 import）
...
| B5 | design Icon 4→2 收斂 + 改 25 screens import | Design git | 中-高 | ⏳ 待 B1+B2 review 通過 |
